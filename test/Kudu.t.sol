...
contract KuduTest is Test {
  ...
  function setUp() public {
    Kudu _kudu = new Kudu();
    TransparentUpgradeableProxy _kuduProxy = new TransparentUpgradeableProxy(address(_kudu), address(vengarl), abi.encodeWithSignature("initialize()"));
  ...
  function test_approvesAndAllowances(uint256 amount) public {
    ...
    assertEqUint(amount + 10e1 * 9, kudu.allowance(address(this), lucatiel));
  }
